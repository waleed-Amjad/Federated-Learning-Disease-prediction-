...
def predict_single(model, features, threshold=0.35):
...
def predict_batch(model, features_list, threshold=0.35):
...
def predict_from_csv(model, csv_path, threshold=0.35, output_suffix='_predictions', 
...
def predict_from_csv_with_analysis(model, csv_path, threshold=0.35, has_labels=False):
    """
...
def batch_predict_multiple_csvs(model, csv_files, threshold=0.35):
